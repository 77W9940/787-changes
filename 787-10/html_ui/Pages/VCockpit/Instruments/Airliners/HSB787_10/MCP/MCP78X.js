var b78xmcp = (function (exports) {
    ...
    /** 787 MCP */
    class HSB78X_MCP extends BaseInstrument {
        constructor() {
            super(...arguments);
        ...
        Update() {
            ...
            if (this.modeElement && this.mode !== mode) {
                ...
                if (mode === 'MACH') {
                    this.modeElement.classList.add('mach');
                } else {
                    this.modeElement.classList.remove('mach');
                }
                if (mode === 'TRK') {
                    this.modeElement.classList.add('trk');
                } else {
                    this.modeElement.classList.remove('trk');
                }
                if (mode === 'FPA') {
                    this.modeElement.classList.add('fpa');
                } else {
                    this.modeElement.classList.remove('fpa');
                }
            }
    ...
    registerInstrument('wt-b787-mcp', HSB78X_MCP);

    exports.HSB78X_MCP = HSB78X_MCP;
